...
### Requirement: HarnessSettings supports canary_enabled
`HarnessSettings`에 `canary_enabled` 필드가 추가된다. 기본값은 false. metadata-based phase/signal canary evaluation 활성화 여부.
